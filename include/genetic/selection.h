...
public:
	base_selection();
	virtual void init(matrix_t* data_volume, matrix_t* transfer_cost, std::vector<permutation>& population, std::vector<permutation>& descendants, std::size_t beta = 0);
	void exec();
protected:
	...
	matrix_t* my_data_volume;
	matrix_t* my_transfer_cost;
...
private:
	virtual void init(matrix_t* data_volume, matrix_t* transfer_cost, std::vector<permutation>& population, std::vector<permutation>& descendants, std::size_t beta = 0) override;
